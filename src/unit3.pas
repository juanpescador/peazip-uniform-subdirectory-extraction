...
if pw_strength<20 then FormPW.Shape1.Color:=$2244ee
else
   if pw_strength<36 then FormPW.Shape1.Color:=$00bbff
   else
      if pw_strength<48 then FormPW.Shape1.Color:=$00ccaa
      else
         FormPW.Shape1.Color:=$11aa55;
