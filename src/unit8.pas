...
procedure clicklabel_pm(var a: TLabel);
...
///pm
procedure exitlabel_pm(var a: TLabel);
begin
...
with FormPM do
begin
exitlabel_pm(LabelTitlePM1);
exitlabel_pm(LabelTitlePM2);
end;
end;
...
procedure enterlabel_pm(var a: TLabel);
begin
if activelabel_pm=a then exit;
a.Font.Color:=clDefault;
a.Font.Size:=0;
