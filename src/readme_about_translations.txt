Notes about 5.4.0 release:

Modified existing strings in === PeaZip text group ===
txt_2_7_updating: Updating existing archive
txt_error_passwordnotmatch: "Password" and "Confirm" fileds doesn't match, please correct them
txt_pw_confirm: Confirm
txt_savehistory: Save history data


Please take time to check the === about text group === against default.txt, in order to check if the localized Tutorial is up to date.

Please note in Tutorial section, links to online resources were updated:
Downloads: http://peazip.sourceforge.net/ | http://www.peazip.org/
